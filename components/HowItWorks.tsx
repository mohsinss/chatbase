      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-32">
          {steps.map((step, index) => (
            ...
            >
              <div 
                className={`md:w-1/2 mb-8 md:mb-0 opacity-0 transition-all duration-1000 transform ${
              ...
              <div 
                className={`md:w-1/2 ${index % 2 === 1 ? 'md:pr-16' : 'md:pl-16'} opacity-0 transition-all duration-1000 transform ${
                  index % 2 === 0 ? '-translate-x-20' : 'translate-x-20'
                }`}
