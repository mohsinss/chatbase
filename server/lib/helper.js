...
export async function removeForbiddenCharacters(input) {
...
export function getSavedPhoneNumber(number) {
...
export const prepareMediaMessage = async (sock, mediaMessage) => {
  try {
...
export async function delayMsg(delay, sock, recipient) {
