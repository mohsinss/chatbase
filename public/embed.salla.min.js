(function () {
    ...
    function handleResponsiveDesign(currentSettings) {
        ...
        if (!isMobile) {
            chatContainer.style = `
                    ...
                    bottom: 90px;
                    left: ${settings?.bubbleAlignment == "left" ? "20px" : "unset"};
                    right: ${settings?.bubbleAlignment == "left" ? "unset" : "20px"};
    ...
    //Fetch chatbotId
    async function fetchSallaSettings(storeId) {
        try {
    ...
    async function initializeChatElements() {
        ...
        const sallaSettings = await fetchSallaSettings(storeId);
        const playgroundChatbotId = sallaSettings.chatbotId;
        console.log('Playground Chatbot ID:', playgroundChatbotId);

        let settings = await fetchChatbotSettings(playgroundChatbotId);
        settings = {
            ...settings,
            ...sallaSettings,
        }
        ...
        //   transform: translateY(-50%);
          ...
          bottom: 20px;
          left: ${settings?.bubbleAlignment == "left" ? "90px" : "unset"};
          right: ${settings?.bubbleAlignment == "left" ? "unset" : "90px"};
        }
        ...
        #chatbot-tooltip::after {
          ...
          position: absolute;
          top: 50%;
          right: ${settings?.bubbleAlignment == "left" ? "unset" : "-10px"};
          left: ${settings?.bubbleAlignment == "left" ? "-10px" : "unset"};
          transform: translateY(-50%);
          border-style: solid;
          border-width: ${settings?.bubbleAlignment == "left" ? "10px 10px 10px 0" : "10px 0 10px 10px"};
          border-color: ${settings?.bubbleAlignment == "left" ? "transparent white transparent transparent" : "transparent transparent transparent white"};
        }
    ...
    `;
        ...
        if (settings?.bubbleAlignment == "left") {
            chatIcon.style.left = "20px";
            chatIcon.style.right = "unset";
        ...
        if (settings?.theme == 'dark') {
            ...
            darkModeArrow.textContent = `
                #chatbot-tooltip::after {
                    border-color: ${settings?.bubbleAlignment == "left" ? "transparent black transparent transparent" : "transparent transparent transparent black"};
                }
            `;
        ...
        tooltip.addEventListener("click", toggleChatWindow);
