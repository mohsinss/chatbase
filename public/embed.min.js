...
(function () {
    ...
    chatIcon.innerHTML = '<div>💬</div>'; // You can use an icon or emoji
    ...
    // closeButton.innerHTML = '✖'; // Close icon (you can replace this with an SVG or other icon)
    ...
    closeButton.addEventListener('click', () => {
        chatContainer.style.display = 'none'; // Hide chat window
        chatIcon.innerHTML = '<div>💬</div>'; // Reset chat icon
