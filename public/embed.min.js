    ...
    async function initializeChatElements() {
        ...
        const positionTooltip = () => {
            ...
            if (window.innerWidth <= 640) {
                ...
                tooltip.style.left = `${iconRect.left - 280}px`;
            }
        ...
        function toggleChatWindow(e) {
            ...
            if (chatContainer.style.display === 'none' || chatContainer.style.display === '') {
                ...
                if (settings?.chatIconUrl) {
                    ...
                    chatIcon.style.background = 'black';
        ...
        function handleClickOutside(e) {
            if (!chatContainer.contains(e.target) && !chatIcon.contains(e.target) && chatContainer.style.display !== 'none') {
                toggleChatWindow();
